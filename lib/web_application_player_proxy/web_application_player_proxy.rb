...
require File.expand_path('../../bots/mongo_db_update_test_bot', __FILE__)
...
class WebApplicationPlayerProxy
   ...
   # @param [GameDefinition] game_definition The definition of the game of which this match is an instance.
   # @param [Integer] number_of_hands The number of hands in this match.
   def initialize(match_id, dealer_information, game_definition, number_of_hands=1)
      MongoDbUpdateTestBot.play dealer_information, match_id
