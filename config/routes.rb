AcpcPokerGuiClient::Application.routes.draw do
  ...
  match 'match_start/start_exhibition_match' => 'match_start#start_exhibition_match', :as => :start_exhibition_match
  ...
  match 'realtime/constants' => 'application#realtime_constants', :as => :realtime_constants
end
