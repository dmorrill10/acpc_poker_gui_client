...
Vagrant.configure("2") do |config|
  ...
  #config.vm.synced_folder "../../My Documents/Github", "/github"
  ...
  # the file Official Ubuntu 12.04 daily Cloud Image i386 (No Guest Additions).pp in the manifests_path directory.
  #
